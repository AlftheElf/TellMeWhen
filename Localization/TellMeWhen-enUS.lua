...
TELLMEWHEN_ICONMENU_ONLYONRAID = "Only on raid";
...
TELLMEWHEN_ICONMENU_TOTEM = "Totem/non-MoG Ghoul";
...
TELLMEWHEN_UIPANEL_GROUPRESETHEADER = "Position Reset";
TELLMEWHEN_UIPANEL_GROUPRESET = "Reset";
