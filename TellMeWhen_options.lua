...
function TellMeWhen_IconMenu_Initialize()
	...
	-- only on raid icon
	info = UIDropDownMenu_CreateInfo();
	info.value = "OnlyOnRaid";
	info.text = TELLMEWHEN_ICONMENU_ONLYONRAID; -- I added a line in /Localizations/TellMeWhen-enUS.lua to define this string.
	info.checked = onlyOnRaid;
	info.func = TellMeWhen_IconMenu_ToggleSetting;
	info.keepShownOnClick = true;
	UIDropDownMenu_AddButton(info);
	--END EDITED--
